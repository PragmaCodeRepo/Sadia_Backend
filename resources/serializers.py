...
class ProfilesSerializer(serializers.ModelSerializer):
    class Meta:
        model = profiles
        fields = ['category','id','first_name',"last_name",'designation','practice_names','education','state','city','zip_code','address','mobile_number','email_address','introduction','speciality','linkdin_profile','rating','link','image','mapaddress','add_date']
